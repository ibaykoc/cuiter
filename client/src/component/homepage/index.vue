<template lang="pug">
  div.uk-width-1-2
      div.
      span#icon(uk-icon="icon: pencil; ratio: 2;", style="color:#00aced;")
      span.uk-text-capitalize.uk-text-bold.uk-button.uk-button-default.uk-align-right.uk-border-pill(
